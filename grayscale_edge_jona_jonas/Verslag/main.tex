...
De ingelezen afbeelding zetten we met \q{lodepng} om naar een \'e\'endimensionale array met structuur zoals weergegeven in \ref{fig:1}.
    ...
    Hier moeten we er rekening mee houden dat het \q{alpha} kanaal, dat de opacity bepaald, altijd de waarde 255 moet hebben, om de afbeelding niet doorzichtig te maken.
