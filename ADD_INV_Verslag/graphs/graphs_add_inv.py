...
data = pd.read_csv('E:\GOOGLE_DRIVE\SCHOOL 2019-2020\Geavanceerde computerarchitectuur\Labo\ADD_INV_Verslag\graphs\ADD_gpu_with_memcopy_10mil_goed.csv')
...
####### OPSLAAN #######
plt.savefig('ADD_gpu_with_memcopy_10mil_goed.pgf', bbox_inches='tight')
...
data = pd.read_csv('E:\GOOGLE_DRIVE\SCHOOL 2019-2020\Geavanceerde computerarchitectuur\Labo\ADD_INV_Verslag\graphs\ADD_gpu_without_memcopy_10mil.csv')
# als je deze methode gebruikt voor de data in lezen
# dan moet de eerste regel van het bestand de kolomnamen bevatten 
# zo kan je er naar verwijzen en zo de data verwerken en plotten
# deze naam wordt ook in de legende gebruikt 
...
####### OPSLAAN #######
plt.savefig('ADD_gpu_without_memcopy_10mil.pgf', bbox_inches='tight')
...
data = pd.read_csv('E:\GOOGLE_DRIVE\SCHOOL 2019-2020\Geavanceerde computerarchitectuur\Labo\ADD_INV_Verslag\graphs\INV_gpu_with_memcopy_100mil.csv')
# als je deze methode gebruikt voor de data in lezen
# dan moet de eerste regel van het bestand de kolomnamen bevatten 
# zo kan je er naar verwijzen en zo de data verwerken en plotten
# deze naam wordt ook in de legende gebruikt 
...
####### OPSLAAN #######
plt.savefig('INV_gpu_with_memcopy_100mil.pgf', bbox_inches='tight')
...
data = pd.read_csv('E:\GOOGLE_DRIVE\SCHOOL 2019-2020\Geavanceerde computerarchitectuur\Labo\ADD_INV_Verslag\graphs\INV_gpu_without_memcopy_100mil.csv')
# als je deze methode gebruikt voor de data in lezen
# dan moet de eerste regel van het bestand de kolomnamen bevatten 
# zo kan je er naar verwijzen en zo de data verwerken en plotten
# deze naam wordt ook in de legende gebruikt 
...
####### OPSLAAN #######
plt.savefig('INV_gpu_without_memcopy_100mil.pgf', bbox_inches='tight')
